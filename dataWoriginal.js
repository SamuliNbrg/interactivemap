...
var groupe = [{
    ...
    x: 3078,
    y: 6644,
    txt1: "<p>Underwater lighthouse at the edge of Umberlee's Cache, lit by a magical light which guides the merfolk patrols and keeps the sea wraiths confined within the caverns below.</p>",
    ref: "H7"
}, {
    name1: "Troll Gate",
    name2: "",
...
},
{
    ...
    x: 661,
    y: 1760,
    txt1: "<p>Inn. It provides a good place for wealthy merchants who want no trouble over a place to stay, but no food. Proprietor: Cheth Thanion is far more alert than he seems. He never forgets a face or anyone doing him out of money.</p>",
    ref: "$43"
}, {
    ...
    x: 781,
    y: 1713,
    txt1: "<p>This old, opulent inn is much favored by young couples and by Waterdeep's paid escorts. No food or drink is available. Utmost discretion is observed. The inn is used by many to conduct sensitive business deals. Yuth Sammardoun, the proprietor, is a cynical, crafty man.</p>",
    ref: "$45"
}, {
    ...
    x: 2275,
    y: 1609,
    txt1: "<p>A relatively new tavern with shoddy workmanship. The owner covets the location of Trollskull Manor.</p>"
}, {
    ...
    name1: "Trollskull Manor",
    name2: "",
    color: "#FF0000",
    x: 2420,
    y: 1588,
    txt1: "<p>Inn. An old run down Inn that hasn't been open for some years now following an explosion that killed a number of patrons and the bartender</p>",
    ref: "T1"
}, {
...
},
{
    ...
    x: 1957,
    y: 3460,
    txt1: "<p>Guildhall. Magic items. Scrolls. Watchful Order of Magists & Protectors.</p>",
    ref: "C15"
}, {
    ...
    x: 1756,
    y: 4107,
    txt1: "<p>Guildhall. Fellowship of Innkeepers.</p>",
    ref: "C39"
}, {
    name1: "The Map House",
    name2: "",
    ...
    x: 2422,
    y: 4031,
    txt1: "<p>Guildhall. Entertainers. Council of Musicians, Instrument-Makers, & Choristers.</p>",
    ref: "T19"
}, {
...
},
{
    ...
    x: 2412,
    y: 5429,
    txt1: "<p>This curiosity shop is filled with lots of battle trophies and souvenirs from Undermountain. Worth a look to see the stuffed beholder for which the shop is named. The shopkeeper is a deep gnome.</p>",
    ref: "D71"
}, {
    ...
    x: 2260,
    y: 3103,
    txt1: "<p> Weirdbottle's Concoctions is managed Skeemo Weirdbottle. This rock gnome sold non-magical potions.</p>"
}, {
...
},
{
    ...
    x: 989,
    y: 2842,
    txt1: "<p>Blackstaff is the title and name given to the master of the eponymous staff and the Archmage of Waterdeep. Vajra Safahr Vajra, a young woman from Tethyr, is the current Blackstaff.</p>",
    ref: "C6"
}, {
    name1: "The Cynosure",
    name2: "",
...
},
{
    ...
    x: 2081,
    y: 3929,
    txt1: "<p>Recently, a masked, rapier-wielding, quietly chuckling assailant has made this a dangerous place for women after dark.</p>"
}, {
    ...
    x: 2811,
    y: 5078,
    txt1: "<p>In the event that Waterdeep is invaded, huge sections of stone wall can be magically brought from the ethereal plane to block major roads in the city at strategic points, forming an inner ring of defensible walls. And just south of this alleyway one such wall will block the High Road.</p>"
}, {
    name1: "The Ghostwalk",
    name2: "",
    color: "#FFFFFF",
    ...
    x: 1406,
    y: 3828,
    txt1: "<p>Opening off Shadows Alley north of Cage Street in the first block of buildings east of Piergeiron's Palace, this tiny threelegged passage is crowded with the lemon trees for which it is named. Brought here by a local wizard, whose spells give heat enough to keep them alive, these tropical trees are an unexpected delight. Waterdeep is much too cold for them to survive under normal conditions. Those who are tempted to take fruit from the trees, break a branch off, or just take a swing at one of them, are warned that the wizard, Narthindlar of the Nine Spells, has set a guardian monster on these trees: a bear (a monster zombie) that usually sits quietly under one of the trees.</p><p>If you harm or take from a tree, it rises up and drives you away. Narthindlar has provided benches under the trees, and can sometimes be found sitting on one of them, puffing on a pipe and contemplating life, Faerun, and magic. He smokes tobacco into which cherries have been crushed, and it gives off a delightful odor. Diplomats who need to blow off steam or chat away from prying ears in the palace sometimes find their way here, too.</p>"
}, {
...
},
{
    ...
    x: 1374,
    y: 2134,
    txt1: "<p>Residents are Renaer 'Ren' Neverember (son of Dagult Neverember and Lady Brandarth, sage and book-collector, rake by night), Madrak Salibuck (Renaer calls him 'old hin', white-haired halfling butler, looked out for Renaer since childhood, was servant to Renaers mother) and Bramal Salibuck (Madrak's son, manages bulk of Neverember business as Renaers proxy).</p>"
}, {
    ...
    x: 1723,
    y: 3452,
    txt1: "<p>Marble four-story villa owned by Renaer Neverember.</p>"
}, {
...
},
{
    ...
    name1: "Vressa's Sweep Begone / Tiger's Eye",
    name2: "",
    color: "#FF00FF",
    x: 2359,
    y: 1586,
    txt1: "<p>This three-floors-plus old building was converted into business offices in 1494 DR. The current owner, a gnome named Hardyn Glorjarn, lives on the top floor.</p><p><strong>Vressa's Sweep Begone</strong> (ground floor office, back): Vressa Iyrunhund hires herself out to 'sweep' North Ward and Sea Ward buildings of rats and mice, employing large capture-boxes and cantrips, since two decades. A typical sweep takes about 3 hours and costs 50 gp.</p><p><strong>Tiger's Eye</strong> (ground floor office, front): Velardar Vincent Trench is a human private detective.</p><p>And in the four upstairs offices:</p><p><strong>Erro Alhandrar's Nets</strong>, an half-elf importer of knotted fishing nets.</p><p><strong>Demra Samdro's Best Beds</strong>, an outcast female dwarf retired adventurer, now making and selling grand beds that disassemble.</p><p><strong>Laskalan's Lamps and Lanterns</strong>, a fussy old man importer -not a maker- who fixes and sells new lamps and lanterns, wicks, oil and candles.</p><p><strong>Tantra Jaressra's Fine Gowns</strong>, importer, maker, alterer, and cleaner of high-fashion gowns for feast and revel wear.</p><p><a href='https://youtu.be/m7t7AZ8-c0A?t=1275' target='_blank'><i class='fa-brands fa-youtube'></i> MORE BY ED GREENWOOD</a></p>",
    ref: "EGYT"
}, ];
